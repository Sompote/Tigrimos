...
function Icon({ name }: { name: string }) {
  const icons: Record<string, string> = {
    ...
    localfile: "M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z",
    ...
    <div className="layout">
      <header className="header">
        ...
        <div className="header-logo">
          ...
          <span className="logo-badge" style={{ opacity: 0.6, fontSize: 9 }}>v1.4.0</span>
